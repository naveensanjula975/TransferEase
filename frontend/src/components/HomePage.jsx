...
const HomePage = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* CTA Section */}
      <div className="relative py-24 mx-4 my-8 overflow-hidden bg-orange-400 rounded-3xl">
          ...
          <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
            <div className="max-w-xl">
              ...
              <p className="mb-8 text-lg text-gray-800">
                For faster, easier transferring and save time.
              </p>
              <button className="px-8 py-3 text-white transition-all transform bg-gray-900 rounded-lg hover:bg-gray-800 hover:scale-105 focus:ring-2 focus:ring-gray-700">
                Get Start
              </button>
            </div>
        ...
        <div className="absolute top-0 right-0 w-full h-full overflow-hidden">
          <svg
            className="absolute right-0 w-1/2 h-full text-gray-900 transform opacity-5 translate-x-1/3"
            viewBox="0 0 100 100"
            preserveAspectRatio="none">
            <path
              d="M0,0 C40,40 60,0 100,0 L100,100 L0,100 Z"
              fill="currentColor"
            />
          </svg>
          <svg
            className="absolute right-0 w-1/2 h-full text-gray-900 transform translate-x-1/2 opacity-5"
            viewBox="0 0 100 100"
            preserveAspectRatio="none">
            <path
              d="M0,0 C50,50 70,0 100,0 L100,100 L0,100 Z"
              fill="currentColor"
            />
          </svg>
          <svg
            className="absolute right-0 w-1/2 h-full text-gray-900 transform opacity-5 translate-x-2/3"
            viewBox="0 0 100 100"
            preserveAspectRatio="none">
            <path
              d="M0,0 C60,60 80,0 100,0 L100,100 L0,100 Z"
              fill="currentColor"
            />
          </svg>
        </div>
      ...
      <footer className="py-8 bg-white border-t border-gray-200">
        <div className="container px-4 mx-auto">
          <div className="grid items-center justify-between grid-cols-1 gap-8 md:grid-cols-3">
            <div className="flex items-center justify-center md:justify-start">
              <img src={Logo} alt="CodeVerse" className="h-20" loading="lazy" />
            </div>
            <div className="text-center">
              <p className="text-gray-600">
                No. 341, Alvitigala Mawatha,
                <br />
                Colombo 05, Narahenpita, Sri Lanka.
              </p>
              <div className="mb-4">
                <a
                  href="tel:+94718956123"
            ...
            <div className="flex flex-col items-center md:items-end">
              <div>
                <p className="mb-3 font-medium text-gray-900">Follow Us</p>
                <div className="flex gap-4">
                  <a
                    href="#"
                    className="flex items-center justify-center w-8 h-8 text-gray-600 transition-colors border border-gray-300 rounded-full hover:text-orange-500 hover:border-orange-500"
                    aria-label="Twitter">
                    <svg
                      className="w-4 h-4"
                      fill="currentColor"
          ...
          <div className="pt-8 mt-8 text-center border-t border-gray-200">
            <p className="text-gray-600">
              Copyright 2025 © CodeVerse, All Rights Reserved.
            </p>
          </div>
        </div>
      </footer>
