...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const authResult = await MockAuthService.login(data.email, data.password);
      
      // Store the session token
      localStorage.setItem('transferease_token', authResult.token);
      
      // Login user with the authentication context
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold text-gray-900">
            Sign in to TransferEase
          </h2>
          <p className="mt-2 text-sm text-gray-600">
            Access your vehicle transfer dashboard
          </p>
        </div>
